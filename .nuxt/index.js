...
import nuxt_plugin_axios_352bbd2a from 'nuxt_plugin_axios_352bbd2a' // Source: ./axios.js (mode: 'all')
...
async function createApp (ssrContext) {
  ...
  const app = {
    head: {"title":"Gamesoft","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Gamesoft Frontend"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.png"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_axios_352bbd2a === 'function') {
    await nuxt_plugin_axios_352bbd2a(app.context, inject)
  }
  ...
  if (process.client && typeof nuxt_plugin_vuecsvimport_88841232 === 'function') {
    await nuxt_plugin_vuecsvimport_88841232(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_localstorage_6bbb00a5 === 'function') {
    await nuxt_plugin_localstorage_6bbb00a5(app.context, inject)
  }
